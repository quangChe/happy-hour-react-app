...
const Navbar = (props) => props.loading 
  ? null
  : (
    <div id="container" style={{color: colors.black}} onClick={() => console.log('Hello')}>
      <svg className="logo" xmlns="http://www.w3.org/2000/svg" width="32" height="32" x="0" y="0"  version="1.1" viewBox="0 0 32 32">
        ...
        <path fill="#dad3b8" d="M24.5 3C21.46 3 19 5.46 19 8.5s2.46 5.5 5.5 5.5S30 11.54 30 8.5 27.54 3 24.5 3zm0 10c-2.48 0-4.5-2.02-4.5-4.5S22.02 4 24.5 4 29 6.02 29 8.5 26.98 13 24.5 13z" coriginal="rgb(77, 81, 82, 1)" colortype="16" awdzp="16"/>
        <path fill="transparent" d="M23.35 9.35l-7.5 7.5c-.81.82-1.49 1.15-2.35 1.15-.85 0-1.55-.34-2.35-1.15l-7.5-7.5c-.15-.14-.19-.35-.11-.54S3.8 8.5 4 8.5h19c.2 0 .38.12.46.31s.04.4-.11.54z" coriginal="rgb(172, 240, 242, 1)" colortype="1" awdzp="1" colorover="rgb(213, 206, 179)"/>
